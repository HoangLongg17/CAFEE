...
namespace DAO
{
    public class ThongKeDAO
    {
        ...
        public List<HoaDonDTO> GetHoaDonList(DateTime? tuNgay, DateTime? denNgay, int? maLoai)
        {
            ...
            string query = @"
        SELECT 
            h.Mahd, h.Ngaylap, h.Tongtien AS TongTienSauGiam,
        ...
        ORDER BY h.Ngaylap DESC";
            ...
            foreach (DataRow row in data.Rows)
            {
                ...
                // Tính tổng tiền gốc từ CHITIETHD
                decimal tongTienGoc = TinhTongTienGoc(maHD);
                decimal tongTienSauGiam = (decimal)row["TongTienSauGiam"];
                ...
                HoaDonDTO hoaDon = new HoaDonDTO
                {
                    ...
                    PhanTramGiam = null, // Nếu cần, JOIN thêm bảng KIEUVC để lấy phần trăm
